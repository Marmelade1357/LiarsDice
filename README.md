...
- **Inszenierung**: Kameraflug über die Insel zum Spielstart (Klick oder Taste überspringt), am Spielende fährt die Kamera vor die jubelnde Siegerente, die Platzierungen erscheinen als Schriftrolle.
- **Lebendige Enten**: Leerlauf-Animationen (Schluck aus dem Holzkrug, auf den Tisch trommeln, strecken, umschauen, Kopf kratzen) und Mimik über die Augenbrauen (skeptisch beim Gebot, wütend beim „Lügner!“, traurig beim verlorenen Würfel, triumphierend beim Sieg).
